...
import sys
sys.path.insert(0, Config.mano_path)
import manopth
...
class MANO(object):
    ...
    def get_layer(self):
        return ManoLayer(mano_root=osp.join(Config.mano_path, 'mano', 'models'), flat_hand_mean=False, use_pca=False, side='right') # load right hand MANO model
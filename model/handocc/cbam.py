...
class Learnable(nn.Module):
    def __init__(self):
        ...
        self.weight = torch.nn.Parameter(torch.rand((1, 1, 32, 32)))
    def forward(self, scale, depth):
...
class SpatialGate(nn.Module):
    ...
    def forward(self, img, depth):
        ...
        # print(depth)
        scale = self.weight(scale, depth)
        # print(scale)
        return img*scale, img*(1-scale)

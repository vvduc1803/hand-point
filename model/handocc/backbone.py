...
from model.handocc.cbam import SpatialGate
...
class FPN(nn.Module):
    def __init__(self, pretrained=True):
        ...
        # Bottom-up layers
        self.layer0 = nn.Sequential(resnet.conv1, resnet.bn1, resnet.SiLU, resnet.maxpool)
    ...
    def forward(self, x):
        ...
        return (c2, c3, c4, c5), p2

class RGB_Depth(nn.Module):
    def __init__(self):
        super(RGB_Depth, self).__init__()
        self.attention_module = SpatialGate()

    def forward(self, img, depth):
        primary_feats, secondary_feats = self.attention_module(img, depth)
